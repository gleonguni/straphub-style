...
export function BrandShowcase() {
  return <section className="py-8 md:py-10 border-y border-border overflow-hidden">
      <div className="container px-4">
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-4 md:gap-6">
          {brands.map(brand => <Link key={brand.name} to={brand.href} className="flex flex-col items-center gap-1 md:gap-2 p-2 md:p-3 rounded-lg hover:bg-muted transition-colors group">
