          ...
          <div className="max-w-xl mx-auto text-center">
            ...
            <form className="flex gap-2 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 bg-background/10 rounded-lg text-sm placeholder:text-background/50 focus:outline-none focus:ring-2 focus:ring-primary"
              />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-background/70">
              <li className="flex items-start gap-2">
                ...
                <span>40 South Way<br />London, HA9 0SR<br />United Kingdom</span>
              </li>
        ...
        <div className="container py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap justify-center">
              ...
              {["Visa", "Mastercard", "PayPal", "Apple Pay", "Google Pay", "Klarna"].map((method) => (
                <div 
                  key={method}
                  className="px-3 py-1.5 bg-background/10 rounded text-xs font-medium text-background/70"
                >
                  {method}
                </div>
              ))}
